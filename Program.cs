...
namespace FastFloatTestBench
{
  ...
  public class Program
  {
    ...
    static void Main(string[] args)
    {
      ...
      //var config = new DebugInProcessConfig().WithSummaryStyle(SummaryStyle.Default.WithMaxParameterColumnWidth(100));
  ...
  //  [ArgumentsSource(nameof(MultiColFiles))]
    ...
    [Benchmark(Description = "FastFloat.TryParse() - multicol")]
    [ArgumentsSource(nameof(MultiColFiles))]
  ...
  //  [ArgumentsSource(nameof(SingleColFiles))]
    ...
    [Benchmark(Description = "FastFloat.TryParseDouble() - singlecol")]
    [ArgumentsSource(nameof(SingleColFiles))]
